...
namespace OSharp.Utility.IM
{
    public interface IIm
    {
        ...
        /// <returns></returns>
        T GetUsers<T>(int limit, string cursor = "");
        ...
        /// <param name="userName">用户名</param>
        /// <returns></returns>
        T DeleteUser<T>(string userName);
        ...
        /// <returns></returns>
        T ResetPsw<T>(string userName, string newPsw);
        ...
        /// <returns></returns>
        T ResetNickName<T>(string userName, string newNickName);
        ...
        /// <returns></returns>
        T AddFriend<T>(string owner, string friend);
        ...
        /// <returns></returns>
        T RemoveFriend<T>(string owner, string friend);
        ...
        /// <param name="userName">用户名</param>
        /// <returns></returns>
        T GetFriends<T>(string userName);
        ...
        /// <param name="userName">用户名</param>
        /// <returns></returns>
        T GetBlockList<T>(string userName);
        ...
        /// <returns></returns>
        T AddToBlockList<T>(string userName, string[] blockUsers);
        ...
        /// <param name="userName">用户名</param>
        /// <returns></returns>
        T GetUsrStatus<T>(string userName);
        ...
        /// <param name="userName">用户名</param>
        /// <returns></returns>
        T GetOfflineMsgCount<T>(string userName);
    }
}
