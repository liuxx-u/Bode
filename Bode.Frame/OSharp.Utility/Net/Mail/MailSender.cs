...
namespace OSharp.Utility.Net.Mail
{
    /// <summary>
    /// 邮件发送者
    /// </summary>
    public class MailSender
    {
        ...
        public MailSender(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
